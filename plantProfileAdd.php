<!DOCTYPE php>
	...
	<div class="form-group">
		...
		<input type="file" class="form-control-file" id="plantPic">
		...
		<div class="form-group">
		<label for="inputState">Minimum Solution Temperature</label>
		...
		<div class="form-group">
		<label for="inputZip">Minimum pH Level</label>
		<input type="text" class="form-control" id="inputMinPH">
		</div>
	<div class="form-group">
	<button type="submit" class="btn btn-success btn-lg">Add</button>
	<a class="btn btn-danger" href="plantList.php">Back</a>
		...
		<script src="plantProfileAdd.js"></script>
